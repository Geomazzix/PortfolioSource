...
namespace mrpoc
{
	...
	private:
		...
		std::unordered_map<unsigned long long, std::unique_ptr<ShaderParameter>> _parameters;

		/// Store all the attributes
		std::unordered_map<std::string, std::unique_ptr<ShaderAttribute>> _attributes;
