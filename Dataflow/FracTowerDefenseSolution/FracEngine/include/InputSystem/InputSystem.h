...
namespace Frac
{
	...
	public:
		...
		*/
		...
		/*!
		* @brief Gets the last used input type. Types defined in Frac::JoystickType. Invalid will refer to keyboard
		* @return JoystickType
		*/
		JoystickType GetLastUsedInputType() const;
	...
	protected:
		...
		char									m_keyOnce[512]{};
		MouseState								m_mouse{};
		JoystickType m_lastUsedJoystick;
	};
