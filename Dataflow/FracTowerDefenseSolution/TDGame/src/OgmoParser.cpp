...
{
	//const std::string test = Frac::FileIO::GetPathFromWildcard("[Levels]") + filepath; //TODO check how to use wildcards
	//std::cout << test << std::endl;
	const std::string JsonString = Frac::FileIO::Read("[Levels]" + filepath);
...
{ 
	...
	LOGINFO("Grid size x:  %i", m_gridSize.x);
	LOGINFO("Grid size y:  %i", m_gridSize.y);
