...
#if _DEBUG
		const char* fmodModulePath = "/app0/libfmodL.prx";
		const char* fmodStudioModulePath = "/app0/libfmodstudioL.prx";
#else
		const char* fmodModulePath = "/app0/libfmod.prx";
		const char* fmodStudioModulePath = "/app0/libfmodstudio.prx";
#endif
